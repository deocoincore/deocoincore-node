...
describe('#defaultBaseConfig', function() {
  it('will return expected configuration', function() {
    ...
    deocoind.spawn.datadir.should.equal(home + '/.deocoin');
    deocoind.spawn.exec.should.equal(path.resolve(__dirname, '../../bin/deocoind'));
  });
  ...
  it('be able to specify a datadir', function() {
    ...
    info.config.servicesConfig.deocoind.spawn.datadir.should.equal('./data2');
  });
});
