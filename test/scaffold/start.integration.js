...
var deocoinService = require('../../lib/services/deocoind');
...
describe('#start', function() {
  ...
  describe('will dynamically create a node from a configuration', function() {
    ...
    it('require each deocoincore-node service with default config', function(done) {
      var node;
      var TestNode = function(options) {
        options.services[0].should.deep.equal({
          name: 'deocoind',
          module: deocoinService,
          config: {
            spawn: {
              datadir: './data'
            }
    ...
    it('require each deocoincore-node service with explicit config', function(done) {
      var node;
      var TestNode = function(options) {
        options.services[0].should.deep.equal({
          name: 'deocoind',
