...
function main(servicesPath, additionalServices) {
  ...
  program
    ...
    .action(function(services){
      ...
      if (!configInfo) {
        throw new Error('Could not find configuration, see `deocoincore-node create --help`');
      }
      var opts = {
      ...
      console.log();
      console.log('    $ deocoincore-node add wallet-service');
      console.log('    $ deocoincore-node add insight-api');
      console.log();
    });
  ...
  program
    ...
    .action(function(services){
      ...
      console.log('  Examples:');
      console.log();
      console.log('    $ deocoincore-node remove wallet-service');
      console.log('    $ deocoincore-node remove insight-api');
      console.log();
    });
