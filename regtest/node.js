...
describe('Node Functionality', function() {
    ...
    rimraf(datadir + '/regtest', function(err) {
      ...
      node.start(function(err) {
        ...
        var syncedHandler = function() {
          if (node.services.deocoind.height === 150) {
            node.services.deocoind.removeListener('synced', syncedHandler);
            done();
          }
        };

        node.services.deocoind.on('synced', syncedHandler);
  ...
  describe('Bus Functionality', function() {
    it('subscribes and unsubscribes to an event on the bus', function(done) {
      ...
      bus.on('deocoind/hashblock', function(data) {
        bus.unsubscribe('deocoind/hashblock');
        if (blockExpected) {
  ...
  describe('Address Functionality', function() {
    ...
    before(function(done) {
      ...
      var startHeight = node.services.deocoind.height;
      node.services.deocoind.on('tip', function(height) {
    ...
    describe('Mempool Index', function() {
      ...
      it('will update the mempool index after new tx', function(done) {
        ...
        node.services.deocoind.sendTransaction(tx.serialize(), function(err, hash) {
