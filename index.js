...
module.exports.services.Bitcoin = require('./lib/services/deocoind');
module.exports.services.deocoin = require('./lib/services/deocoind');
...
module.exports.lib = require('deocoincore-lib');
